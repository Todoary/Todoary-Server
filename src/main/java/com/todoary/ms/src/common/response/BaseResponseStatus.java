...
public enum BaseResponseStatus {
     ...
     */
    // Common
    EMPTY_USER(false, 2001, "회원 정보가 존재하지 않습니다."),
    ...
    TODO_TITLE_TOO_LONG(false, 2403, "투두 제목이 제한길이 이상입니다. ("+TODO_TITLE_MAX_LENGTH+" 글자까지 가능)"),
    EMPTY_TODO_DATE(false, 2304, "투두 날짜를 입력해주세요."),

    // diary 도메인 에러

    USERS_DIARY_NOT_EXISTS(false, 2402, "해당하는 유저와 일치하는 일기가 없습니다."),
    DIARY_TITLE_TOO_LONG(false, 2303, "일기 제목이 제한길이 이상입니다. ("+DIARY_TITLE_MAX_LENGTH+" 글자까지 가능)"),
    ...
    ILLEGAL_ARGUMENT(false, 4005, "잘못된 입력입니다."),
    ILLEGAL_DATETIME(false, 4006, "날짜나 시간 형식을 확인해주세요."),
